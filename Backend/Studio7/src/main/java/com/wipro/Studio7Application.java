	...
	CommandLineRunner init(UserRepository userRepository, ContentRepository contentRepository) {
		return args -> {
			...
			content = new Content(1L, "The Godfather",
					...
					"Action", 0, "English", "2", "4", true, "Marlon Brando, Al Pacino, James Caan", new HashSet<>(),
					new HashSet<>());
			contentRepository.save(content);
			...
			content = new Content(1L, "The Family Man",
					...
					"Action", 0, "Hindi", "1", "3", false, " Manoj Bajpayee, Priyamani", new HashSet<>(),
					new HashSet<>());
			contentRepository.save(content);
			...
			content = new Content(1L, "Breaking Bad",
					...
					"Action", 0, "English", "2", "4", false, " Bryan Cranston, Aaron Paul, Anna Gunn", new HashSet<>(),
					new HashSet<>());
			contentRepository.save(content);
